	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" value="<?php echo $row['pcontact']; ?>" pattern="[0-9]{10}" placeholder="+593..." required="">
	  	</div>
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="" value="">
				...
				<option value="Sexto" <?= $row['class']=='Sexto'? 'selected':'' ?>>Sexto</option>
		    	<option value="Septimo" <?= $row['class']=='Septimo'? 'selected':'' ?>>Septimo</option>
		    	<option value="Octavo" <?= $row['class']=='Octavo'? 'selected':'' ?>>Octavo</option>
		    	<option value="Noveno" <?= $row['class']=='Noveno'? 'selected':'' ?>>Noveno</option>
		    </select>
	  	</div>
	  	<div class="form-group">
